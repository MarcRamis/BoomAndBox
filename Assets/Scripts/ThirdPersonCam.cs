...
public class ThirdPersonCam : MonoBehaviour
{
    ...
    [HideInInspector] public GameObject myCurrentCamera;
    ...
    private void Update()
    {
        ...
        //if (Input.GetKeyDown(KeyCode.Alpha3)) SwitchCameraStyle(CameraStyle.New_Camera);
    ...
    private void SwitchCameraStyle(CameraStyle newStyle)
    {
        ...
        if (newStyle == CameraStyle.New_Camera)
        {
            newCamera.SetActive(true);
            myCurrentCamera = newCamera;
        }
